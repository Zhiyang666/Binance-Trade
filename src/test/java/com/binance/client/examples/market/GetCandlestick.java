...
//        }
        ...
        Page<CandlestickEntity> candlestickEntities = repository.findAllByOpenTimeBetweenAndIntervalEquals(pageable,1596067200000L,1599782400000L,"1d");
        System.out.println(candlestickEntities);

    }

    public static void main(String[] args) {
        System.out.println(new Date(1596067200000L));
