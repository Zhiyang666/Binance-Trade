...
public class SyncRequestImpl implements SyncRequestClient {
    ...
    @Override
    public List<CandlestickEntity> getCandlestick(String symbol, CandlestickInterval interval, Long startTime,
                                                  Long endTime, Integer limit) {
    ...
    @Override
    public List<PriceChangeTickerEntity> get24hrTickerPriceChange(String symbol) {
